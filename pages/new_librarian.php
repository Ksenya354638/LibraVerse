<?php
    ...
    if(isset($_POST['add-librarian'])){
        ...
        $query_create = $conn->prepare("INSERT INTO librarians (FirstName,ParentalName,Surname,Address,PhoneNumber,BirthDate,EmploymentDate,Position,Password) VALUES (:fname, :pname, :sname, :address, :phone, :birthDate, :employmentDate, :position, :password);");
        ...
        $query_create->bindValue(':birthDate',$birthDate, SQLITE3_TEXT);
        $query_create->bindValue(':employmentDate',$employmentDate, SQLITE3_TEXT);
        $query_create->bindValue(':position',$position, SQLITE3_TEXT);
        ...
        echo "<div class='validation-msg done'>
                ...
                <h2 class='validation-text'>Працівника успішно додано до каталогу</h2>     
              </div>";
    }
...
<body>
    ...
    <div class="main-content add">
        ...
        <form class="book-form" method="POST">
                ...
                <label for="employmentDate">Дата прийому на роботу</label>
                <input type="date" id="employmentDate" name="employmentDate" required>
                <label for="position">Посада</label><br>
                <div class="col-lg-12">
                    <div class="radio col-lg-6"><input type="radio" id="position" name="position" value="завідуючий"><p>завідуючий</p></div>
                    <div class="radio col-lg-6"><input type="radio" id="position" name="position" value="бібліотекар"><p>бібліотекар</p></div>           
                </div>
        ...
        <div class="col-lg-6 image">
            <img src="../images/add_librarian.png" alt="зображення бібліотекарки">
        </div>
    </div>
