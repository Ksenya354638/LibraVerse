    ...
    <div class="main-content" id="main-content">
        <div class="banner col-lg-12">
            <div class="banner-text col-lg-5">
                ...
                <p>У LibraVerse ми віримо у трансформаційну силу книги та важливість розвитку спільноти. Наша місія - забезпечити зручний облік книг!</p>
            </div>
        </div>

        <div class="functions col-lg-12">
            <h1>Що Ви можете зробити?</h1>
            <div class="col-lg-3 function"><a href="books_list.php"><h2>Книжковий каталог</h2><p>Пориньте в вашу велику колекцію книг.</p></a></div>
            <div class="col-lg-3 function"><a href="author_list.php"><h2>Профілі авторів</h2><p>Ведіть облік усіх авторів.</p></a></div>
            <div class="col-lg-3 function"><a href="customers_list.php"><h2>Облікові записи клієнтів</h2><p>Відстежуйте прогрес у кількості клієнтів.</p></a></div>
            <div class="col-lg-3 function"><a href="librarians_list.php"><h2>Профілі співробітників</h2><p>Зберігайте інформацію про працівників.</p></a></div>
        </div>
